...
export default class SmokeEmitter{
    ...
    init(){
        ...
        textureLoader.load('https://raw.githubusercontent.com/satyakoppisetti95/portfolio/master/smoke.png', texture => {
            ...
            const smokeGeometry = new THREE.PlaneBufferGeometry(5, 5);
            ...
            while(limit--) {
              ...
              smokeMeshes[limit].position.set(THREE.MathUtils.randFloat(-3,3), THREE.MathUtils.randFloat(-2,2), THREE.MathUtils.randFloat(2,-10));
              smokeMeshes[limit].rotation.z = Math.random() * Math.PI;
    ...
    animate(){
      ...
      while(smokeParticlesLength--) {
        this.smokeParticles[smokeParticlesLength].rotation.z +=  0.002;
      }
    }
}
